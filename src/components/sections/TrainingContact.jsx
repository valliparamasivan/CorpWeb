...
import { TextField, Button, Grid, Snackbar, MenuItem } from '@mui/material';
                ...
                <form onSubmit={handleSubmit}>
                    <Grid container spacing={10} direction="row" justifyContent="flex-start" alignItems="center">
                        <Grid item lg={7} md={12} xs={12}>
                            ...
                            <p>
                                Ready to take your career to the next level? Fill out the form to inquire about our
                                training programs, and one of our representatives will get back to you with more details.
                                Whether you’re interested in Structural Steel Detailing, Full Stack Development, or
                                ServiceNow, we have a program to help you reach your goals.
                            </p>
                        </Grid>
                            ...
                            <Grid container spacing={3}>
                                ...
                                <Grid item lg={12} md={6} xs={12}>
                                    <TextField
                                        fullWidth
                                        select
                                        label="Training Program Interested In"
                                        variant="standard"
                                        size="small"
                                        sx={textFieldStyles}

                                    >
                                        {["Structural Steel Detailing (SDS2)", "Full Stack Software Development", "ServiceNow"].map((option) => (
                                ...
                                <Grid item lg={12} md={6} xs={12}>
                                    <TextField
                                        ...
                                        sx={textFieldStyles}
                                    >
                                        {["Online", "In-Person", "Flexible"].map((option) => (
                                            <MenuItem key={option} value={option}>
                                                {option}
                                            </MenuItem>
                                        ))}
